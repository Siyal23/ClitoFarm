...
public class BuyerDetails {
	...
	public BuyerDetails(int id, String firstName, String lastName, String address, String city, int pincode,
			int mobileno) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Buyer_details [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", address="
